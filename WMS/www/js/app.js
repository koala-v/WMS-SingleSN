...
app.run(['ENV', 'SqlService', 'ApiService', 'PopupService', 'TABLE_DB', '$ionicPlatform', '$rootScope', '$state', '$location', '$timeout', '$ionicPopup', '$ionicHistory', '$ionicLoading', '$cordovaKeyboard', '$cordovaToast', '$cordovaFile',
    function (ENV, SqlService, ApiService, PopupService, TABLE_DB, $ionicPlatform, $rootScope, $state, $location, $timeout, $ionicPopup, $ionicHistory, $ionicLoading, $cordovaKeyboard, $cordovaToast, $cordovaFile) {
